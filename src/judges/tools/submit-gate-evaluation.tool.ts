...
import type { Gate, GateEvaluation, GateJudgment } from '@/judges/types/common.types';

const GATE_VERDICTS: Gate[] = ['yes', 'no'];
const isGate = (g: unknown): g is Gate => GATE_VERDICTS.includes(g as Gate);
