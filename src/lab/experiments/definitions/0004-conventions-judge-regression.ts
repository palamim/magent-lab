...
import { conventionsLabeledDiffs } from '@/lab/fixtures/labeled-diffs/conventions/v1';
...
experiment('conventions-judge regression v1', async (experimentId) => {
  ...
  await runJudgeRegression(subject, conventionsLabeledDiffs, experimentId, RUNS_PER_DIFF);
});
