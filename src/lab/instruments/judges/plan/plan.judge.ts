...
import { comparePlansPrompt, judgePlanPrompt } from '@/lab/instruments/judges/plan/plan.judge.prompt';
import { ANTHROPIC_MODELS } from '@/lab/types/models.types';
import {
  executeSubmitComparativeEvaluation,
  submitComparativeEvaluationTool,
} from '@/lab/instruments/judges/tools/submit-comparative-evaluation.tool';
import {
  executeSubmitGateEvaluation,
  submitGateEvaluationTool,
} from '@/lab/instruments/judges/tools/submit-gate-evaluation.tool';
import type { ComparativeEvaluation, GateEvaluation } from '@/lab/instruments/judges/types/common.types';

const MAX_JUDGE_TOKENS = 4096;
const JUDGE_MODEL = ANTHROPIC_MODELS.CLAUDE_HAIKU_4_5;
