...
export const wrongFilePlaceAndWrongCssNamingDiff: LabeledDiff = {
  key: '0018-wrong-file-place-and-wrong-css-naming',
  description: 'File out of place and css naming using CONSTANT_CASE',
...
+++ b/src/model/direction.view.tsx
@@ -1,59 +1,235 @@
 'use client';
...
-        style={{ color: 'var(--FOREGROUND_MUTED)', fontSize: 13, lineHeight: 1.6 }}
+  return (
+    <div
+      className="rounded"
...
+          Direction Proposal
+        </h2>
+        <p className="mt-1.5" style={{ fontSize: 13, color: 'var(--FOREGROUND_MUTED)', lineHeight: 1.5 }}>
...
+      </div>
  ...
  expected: {
    'Structure and Placement Rules': 'no',
