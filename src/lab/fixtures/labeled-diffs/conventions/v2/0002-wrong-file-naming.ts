...
export const wrongFileNamingDiff: LabeledDiff = {
  key: '0002-wrong-file-naming',
  description: 'Using a file name with CONTANT_CASE instead of the convention kebab-case',
...
+++ b/src/modules/main-panel/DIRECTION_VIEW.tsx
@@ -1,59 +1,235 @@
 'use client';
