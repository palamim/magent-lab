...
export const fileWrongPlaceAndNamingDiff: LabeledDiff = {
  key: '0007-file-wrong-place-and-naming',
  description: 'File is misplaced in lib (should be modules) and is names with wrong camelCase',
