...
export const fileMisplacedWrongComponentNamingDiff: LabeledDiff = {
  key: '0008-file-misplaced-wrong-component-naming',
  description: 'File is misplaced in model (should be in modules) and component uses CONSTANT_CASE',
