...
export const wrongHookNamingInsideDiff: LabeledDiff = {
  key: '0020-wrong-hook-naming-inside',
  description: 'useMagent is called as UseMagent in the component (not the import)',
