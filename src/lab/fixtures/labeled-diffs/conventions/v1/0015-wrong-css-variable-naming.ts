...
export const wrongCssVariableNamingDiff: LabeledDiff = {
  key: '0015-wrong-css-variable-naming',
  description: 'CSS variables naming with PascalCase',
...
+        style={{ background: 'var(--SurfaceRaised)', borderBottom: '1px solid var(--border)' }}
       >
-        {direction.rationale}
-      </pre>
+        <span
...
-        style={{
-          background: acting ? 'var(--SurfaceRaised)' : 'var(--accent)',
