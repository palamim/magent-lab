...
export const noUseClientAndWrongComponentNamingDiff: LabeledDiff = {
  key: '0012-no-use-client-and-wrong-component-naming',
  description: 'No use client on top and wrong component naming',
