...
export const anyTypingAndFileMisplacedDiff: LabeledDiff = {
  key: '0010-any-typing-and-file-misplaced',
  description: 'Uses any for typing and file is in proividers (should be in modules)',
...
+  const coreDocs: { name: any; content: string }[] = [
