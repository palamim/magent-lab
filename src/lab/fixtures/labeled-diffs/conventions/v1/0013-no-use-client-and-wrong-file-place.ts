...
export const noUseClientAndWrongFilePlaceDiff: LabeledDiff = {
  key: '0013-no-use-client-and-wrong-file-place',
  description: 'No use client on top and file out of place',
...
+++ b/src/core/api/direction.view.tsx
@@ -1,59 +1,235 @@
