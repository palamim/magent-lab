...
export const wrongFilePlaceNamingAndNoUseClientDiff: LabeledDiff = {
  key: '0019-wrong-file-place-naming-and-no-use-client',
  description: 'Wrong file place and naming and no use client on top',
