...
export const wrongCssVariableAndAnyTypingDiff: LabeledDiff = {
  key: '0017-wrong-css-variable-and-any-typing',
  description: 'CSS variables using camelCase and any typing',
...
+++ b/src/modules/main-panel/direction.view.tsx
@@ -1,59 +1,235 @@
 'use client';
...
-        style={{ color: 'var(--foregroundMuted)', fontSize: 13, lineHeight: 1.6 }}
+  return (
+    <div
+      className="rounded"
...
+          Direction Proposal
+        </h2>
+        <p className="mt-1.5" style={{ fontSize: 13, color: 'var(--foregroundMuted)', lineHeight: 1.5 }}>
